...
def display_help():
    ...
    help_info = "The Fossil Registration System is a user-friendly application designed to " \
                ...
                " taxonomy, and additional details." \
...
Label(root, text="Date Created:", font="arial 13", bg=background, fg="#fff").place(x=430, y=150)
today = date.today()
